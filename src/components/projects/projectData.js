...
export default [
    ...
    },
    {
        ...
        projectSummary:'The True Altitude Investment Portal was a web app created to faciliate meaninful and productive connections between mentors, investors and companies/start-ups within a closed network.',
        tech: [
            { name: 'VueJS' },
            { name: 'SendGrid' },
            { name: 'Firebase' },
    ...
    },
    {
        ...
        projectSummary:'Simplicity Research web-app developed to provide Simplicity Consultancy with a platform to present their detailed reports of web3 projects/startups. Reports and requests are displayed to the users of the closed platform (VCs & investors).  ',
        tech: [
            { name: 'React' },
            { name: 'NextJS' },
            { name: 'Firebase' },
